...
public class HomePage extends Base {
	...
	static WebDriver driver; // a local driver is created so that this class doesn't have to depend on the
								// driver from Base Class. 'cos there are other
	...
	public void base1PageNavigation(String emailID, String passWord, String text)
		...
		System.out.println("checking this on git");
		System.out.println("checking this on git- this is just a test");
		System.out.println("checking this on git- this is just a test2");
		
		

		Landing_Page_PageObjects lp = new Landing_Page_PageObjects(driver);// this obj exposes the methods present in
